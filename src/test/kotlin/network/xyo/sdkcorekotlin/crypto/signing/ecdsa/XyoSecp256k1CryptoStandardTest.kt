...
class XyoSecp256k1CryptoStandardTest : XyoTestBase() {
    ...
    fun testSecp256k1CryptoStandard () {
        runBlocking {
            ...
            val newInstanceEc = XyoSha256WithSecp256K.newInstance(XyoBuff.newInstance(EC_PRIVATE_KEY, assertedPrivate).bytesCopy)
            ...
            Assert.assertArrayEquals(XyoBuff.newInstance(EC_PRIVATE_KEY, assertedPrivate).valueCopy, ec.privateKey.encoded)
            ...
            for (i in 0..100) {
                ...
                testSigner.signData(byteArrayOf(0x00)).await()
            }
        }
    }
}
